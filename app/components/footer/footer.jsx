    ...
    <footer className="footer" id="footer">
      ...
      <div className="line"></div>
        <p className="footer-des-text">
          ...
          alt="Footer Logo"
          />
          © 2025 Valve Corporation. Tüm hakları saklıdır. Tüm ticari markalar, ABD ve diğer ülkelerde ilgili sahiplerinin mülkiyetindedir.
          Uygulanabilir yerlerde fiyatlara KDV dahildir.
          <Image
          width={80}
          height={20}
          src={'/logo_steam_footer.png'}
          alt="Footer Steam Logo"
          />
        </p>
        <div className="line"></div>
        <p className="links">
